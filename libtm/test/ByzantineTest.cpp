...
void ValidatorSetTest::testByzantine() {
int N = 4;
//logger = consensusLogger().With("test", "byzantine")
ConsensuState css[] = common_test::randConsensusNet(N, "consensus_byzantine_test", newMockTickerFunc(false), newCounter);
...
func byzantineDecideProposalFunc(, height int64, round int, cs *ConsensusState, sw *p2p.Switch) {
