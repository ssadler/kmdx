...
#include <libwingcore/Exceptions.h>
#include <libwingcore/BlockHeader.h>
#include <libwing/CodeSizeCache.h>
...
public:
    ...
    std::pair<ExecutionResult, TransactionReceipt> execute(eth::EnvInfo const& _envInfo, SealEngineFace const& _sealEngine, Transaction const& _t, Permanence _p = Permanence::Committed, eth::OnOpFunc const& _onOp = eth::OnOpFunc());
