...
#include <libwingcore/ChainOperationParams.h>
#include "Account.h"
...
public:
    ...
    ExecutionResult execute(LastBlockHashesFace const& _lh, Transaction const& _t, Permanence _p = Permanence::Committed, eth::OnOpFunc const& _onOp = eth::OnOpFunc());
